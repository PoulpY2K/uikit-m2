...
class DocumentTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return DocumentTableViewController.documents.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = DocumentTableViewController.documents[indexPath.row].title
        cell.detailTextLabel!.text = String(DocumentTableViewController.documents[indexPath.row].size)
        return cell
    }
